...
nwframe = LabelFrame(root,text="Aplikasi Konversi Suhu",padx=10,pady=10)
...
rmslbl = Label(nwframe,text="Formula",bg="white")
rmslbl.place(x = 1, y =90)

rmsnya = Label(nwframe,text="(...°C x 9/5) + 32 = ... °F",bg="white")
